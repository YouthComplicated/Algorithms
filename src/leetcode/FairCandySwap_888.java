...
public class FairCandySwap_888 {
    ...
    public static void main(String[] args) {
        int [] arrA1 = {1,1};
        int [] arrB1 = {2,2};
        System.out.println(Arrays.toString(fairCandySwap(arrA1,arrB1)));
        int [] arrA2 = {1,2};
        int [] arrB2 = {2,3};
        System.out.println(Arrays.toString(fairCandySwap(arrA2,arrB2)));
        int [] arrA3 = {1,2,5};
        int [] arrB3 = {2,4};
        System.out.println(Arrays.toString(fairCandySwap(arrA3,arrB3)));
    }
