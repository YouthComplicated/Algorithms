...
public class StreamTest {
    ...
    public void test04(){
        ...
        List<String> theList11 = Arrays.asList("q","w","e");

        List<String> list2 = stream3.collect(() -> new ArrayList(), (theList, item) -> theList.add(item),
                (theList1, theList2) -> theList1.addAll(theList2));

//        Stream<String> stream31 = Stream.of("hello", "world", "helloworld");
//        List<String> list21 = stream31.collect(() -> theList11, (theList, item) -> theList.add(item),
//                (theList1, theList2) -> theList1.addAll(theList2));
        ...
        System.out.println("EEE======collection:==========");
